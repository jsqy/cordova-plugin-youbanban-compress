...
public class ImageUtils {
     ...
     * @return 返回压缩后图片的存放路径
     */
    public static String saveBitmap(Context context, String path,int toWidth,int toHeight) {
...
//        获取按照屏幕高宽压缩比压缩后的bitmap
        Bitmap bitmap = decodeSampledBitmapFromPath(path, toWidth, toHeight);
        bitmap = Bitmap.createScaledBitmap(bitmap, toWidth, toHeight, true);
